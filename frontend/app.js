...
const translations = {
  ru: {
    ...
    brandSubtitle: "Казахско-кыргызская транскрибация",
    navWelcome: "Главная",
    navCapture: "Запись",
    ...
    heroStatusCopy: "После обработки появятся текст, расшифровка по спикерам и ссылки на документы.",
    ...
    speakerTranscript: "Расшифровка по спикерам",
    ...
    recognitionValue: "Whisper и профильные Kazakh/Kyrgyz ASR модели",
    cisLanguages: "Основные языки",
    ...
    statusSummarizing: "Структурирование",
    ...
    msgSummarizing: "Готовим внутреннюю структуру для экспортных документов.",
    msgDocuments: "Готовим документы.",
    msgCompleted: "Готово. Выберите формат ниже, документ будет собран при скачивании.",
    ...
    sendingRecord: "Запись отправляется на сервер. После обработки появится расшифровка.",
  ...
  kk: {
    ...
    brandSubtitle: "Қазақ-қырғыз транскрибациясы",
    navWelcome: "Басты",
    navCapture: "Жазу",
    navResults: "Нәтиже",
    navSettings: "Баптау",
    ...
    heroStatusCopy: "Өңдеуден кейін мәтін, спикерлер бойынша расшифровка және құжат сілтемелері пайда болады.",
    ...
    speakerTranscript: "Спикерлер бойынша мәтін",
    ...
    recognition: "Тану",
    recognitionValue: "Whisper және Kazakh/Kyrgyz ASR модельдері",
    cisLanguages: "Негізгі тілдер",
    ...
    msgSummarizing: "Экспорт құжаттары үшін ішкі құрылым дайындалуда.",
    msgDocuments: "Құжаттар дайындалуда.",
    msgCompleted: "Дайын. Төменнен формат таңдаңыз, құжат жүктеу кезінде қалыптасады.",
    ...
    sendingRecord: "Жазба серверге жіберілуде. Өңдеуден кейін расшифровка пайда болады.",
  ...
  en: {
    ...
    brandSubtitle: "Kazakh-Kyrgyz transcription",
    navWelcome: "Home",
    navCapture: "Record",
    navResults: "Result",
    ...
    heroStatusCopy: "After processing, transcript text, speaker transcript, and document links will appear.",
    ...
    recognitionValue: "Whisper and specialized Kazakh/Kyrgyz ASR models",
    cisLanguages: "Main languages",
    workMode: "Work mode",
    ...
    msgSummarizing: "Preparing internal structure for export documents.",
    msgDocuments: "Preparing documents.",
    msgCompleted: "Done. Choose a format below; the document will be generated on download.",
    ...
    sendingRecord: "Sending recording to the server. Transcript will appear after processing.",
...
function browserSpeechLanguage() {
  ...
  return prefixMatch ? prefixMatch.code : "kk-KZ";
}
