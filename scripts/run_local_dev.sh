...
export ASR_FAKE_TRANSCRIPT="${ASR_FAKE_TRANSCRIPT:-Это локальный тест QazScribe. Сайт принимает аудио, показывает статусы и готовит документы без платных API.}"
